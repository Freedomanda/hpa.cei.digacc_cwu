			...
			onTheBrowser : {
				...
				actions : {
					...
					iChangeTheHashToTheRememberedItem : function () {
						return this.waitFor({
							success : function () {
								...
								Opa5.getHashChanger().setHash("/DigitalAccount/" + sObjectId);
							}
						});
					},
					
						iRestartTheApp : function () {
					//	var sObjectId;
						this.waitFor({
							success : function () {
					...
					iRestartTheAppWithTheRememberedItem : function (oOptions) {
						...
						return this.waitFor({
							success : function() {
								oOptions.hash = "/DigitalAccount/" + encodeURIComponent(sObjectId);
